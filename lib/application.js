...
function Application (options) {
  ...
  options                 = options || {};
  this.host               = options.host || process.env.IP || 'localhost';
  ...
  // Cookies
  this.cookieSignKeys     = options.cookieSignKeys || ["SECRET_KEY_1", "SECRET_KEY_2"];
  ...
  if (!this.templateEngine) {
    this.templateEngine = new DustEngine({viewsPath: this.viewsPath});
  }
